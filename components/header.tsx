...
export default function Header({ onCartClick, onWishlistClick }: HeaderProps) {
  ...
  const { language, setLanguage, darkMode, setDarkMode } = useUI();
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              >
                ...
                />
                {wishlist.length > 0 && (
                  <span className="absolute -top-1 -right-1 bg-primary text-primary-foreground text-xs font-medium w-5 h-5 flex items-center justify-center rounded-full border border-background">
